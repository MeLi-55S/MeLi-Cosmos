...
def site_meta(request):
    ...
    return {
        ...
        "features": [
            "posts.read", "posts.write", "posts.view_count",
            "memos.read", "memos.write",
            "taxonomies.read", "taxonomies.write", "series.manage",
            "comments.read", "comments.write", "comments.moderate",
            "likes.read", "likes.write",
            "inbox.read", "inbox.write",
            "users.read", "archives.read", "search.read",
            "uploads.images", "uploads.avatar",
            "auth.login", "auth.register", "tokens.manage",
            "profile.write", "invite.generate",
        ],
    }
